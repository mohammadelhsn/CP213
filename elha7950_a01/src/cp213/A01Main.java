...
public class A01Main {
    /**
     * Default Constructor for the A01Main classs -- to avoid JavaDoc warnings
     */
    public A01Main() {
    ...
    // Constants
    /**
     * Variable for the line seperator in between tasks
     */
    private static final String LINE = "-".repeat(40);
    /**
     * Variable for the line seperator in between tests
     */
    private static final String TEST_LINE = "=".repeat(80);
    /**
     * Variable including CipherText for Cipher class testing
     */
	...
	System.out.println();
	// !! TEST CODE FOR validSnFile !!
	// !! Uncomment below and at the top !!
	/*
	 * try { Scanner fileIn = new Scanner( new File(
